        ...
        <div className="flex items-center justify-center mt-12  flex-row flex-wrap gap-10 " data-aos="fade-up ">
          <div className=" boder-black shadow-md hover:scale-105 duration-500 py-2 shadow-purple-500 cursor-pointer rounded-xl  text-xl w-[32rem] font-poppins flex flex-col gap-5 justify-center bg-black " id='raja'>
            <div className="flex justify-center items-center w-[32rem]  " id='raja'>
              <img src={project2} alt='img' className="rounded-tl-lg rounded-tr-lg h-[280px] " id='ai' />
            </div>
            ...
            <div className="flex flex-col font-bold leading-6 gap-3">
              ...
              <h4 className="text-xl flex justify-center mt-3">
                ...
                <a href="https://github.com/hari1998-gif/NewsWeb-NewsAPP" target="_blank" rel="noreferrer" className="cursor-pointer text-2xl duration-150 hover:scale-110 px-10"><FaGithub/></a>
                <a href="https://ai-2023.news.app/"   target="_blank" rel="noreferrer" className="cursor-pointer text-xl duration-150 hover:scale-110"><FaExternalLinkAlt/></a>
              </h4>
            </div>
          </div>
      </div>
...
{/* -------------------------2nd block -------------------------------------*/}
        ...
        <div className="flex items-center justify-center mt-12  flex-row flex-wrap gap-10 " data-aos="fade-up ">
          <div className=" boder-black shadow-md hover:scale-105 duration-500 py-2 shadow-red-500 cursor-pointer rounded-xl  text-xl w-[32rem] font-poppins flex flex-col gap-5 justify-center bg-black " id='raja'>
            <div className="flex justify-center items-center w-[32rem]  " id='raja'>
              <img src={project3} alt='img' className="rounded-tl-lg rounded-tr-lg " />
            </div>
            ...
            <div className="flex flex-col font-bold leading-6 gap-3">
              ...
              <h4 className="text-xl flex justify-center mt-3">
                ...
                <a href="https://github.com/hari1998-gif/MessagesApp" rel="noreferrer"  target="_blank" className="cursor-pointer text-2xl duration-150 hover:scale-110 px-10"><FaGithub/></a>
                <a href="https://web-news.vercel.app/" rel="noreferrer"  target="_blank" className="cursor-pointer text-xl duration-150 hover:scale-110"><FaExternalLinkAlt/></a>
              </h4>
            </div>
          </div>
      </div>
...
{/* -------------------------3rd block -------------------------------------*/}
        ...
        <div className="flex items-center justify-center mt-12  flex-row flex-wrap gap-10 " data-aos="fade-up ">
          <div className=" boder-black shadow-md hover:scale-105 duration-500 py-2 shadow-indigo-900 cursor-pointer rounded-xl  text-xl w-[32rem] font-poppins flex flex-col gap-5 justify-center bg-black " id='raja'>
            <div className="flex justify-center items-center w-[32rem]  " id='raja'>
              <img src={project4} alt='img' className="rounded-tl-lg rounded-tr-lg " />
            </div>
            ...
            <div className="flex flex-col font-bold leading-6 gap-3">
              ...
              <h4 className="text-xl flex justify-center mt-3">
                ...
                target="_blank" rel="noreferrer" className="cursor-pointer text-2xl duration-150 hover:scale-110 px-10"><FaGithub/></a>
                <a href="#" target="_blank" rel="noreferrer" className="cursor-pointer text-xl duration-150 hover:scale-110"><FaExternalLinkAlt/></a>
              </h4>
            </div>
          </div>
      </div>
...
{/* -------------------------4th block -------------------------------------*/}
        ...
        <div className="flex items-center justify-center mt-12  flex-row flex-wrap gap-10 " data-aos="fade-up ">
          <div className=" boder-black shadow-md hover:scale-105 duration-500 py-2 shadow-green-500 cursor-pointer rounded-xl  text-xl w-[32rem] font-poppins flex flex-col gap-5 justify-center bg-black " id='raja'>
            <div className="flex justify-center items-center w-[32rem]  " id='raja'>
              <img src={project1} alt='img' className="rounded-tl-lg rounded-tr-lg " />
            </div>
            ...
            <div className="flex flex-col font-bold leading-6 gap-3">
              ...
              <h4 className="text-xl flex justify-center mt-3">
                ...
                <a href="https://github.com/hari1998-gif/Fitness-Tracker" rel="noreferrer" target="_blank" className="cursor-pointer text-2xl duration-150 hover:scale-110 px-10"><FaGithub/></a>
                <a href="#" target="_blank" rel="noreferrer" className="cursor-pointer text-xl duration-150 hover:scale-110"><FaExternalLinkAlt/></a>
              </h4>
            </div>
          </div>
